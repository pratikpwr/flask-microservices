...
def add(n1, n2):
    api_url =  "http://172.17.0.1:5051/" + str(n1) + "/" + str(n2)
...
def minus(n1, n2):
    api_url = "http://172.17.0.1:5052/" + str(n1) + "/" + str(n2)
    response = requests.get(api_url)
    result = response.json()['result']
    return result
...
def multiply(n1, n2):
    api_url = "http://172.17.0.1:5053/" + str(n1) + "/" + str(n2)
    response = requests.get(api_url)
    result = response.json()['result']
    return result
...
def divide(n1, n2):
    api_url = "http://172.17.0.1:5054/" + str(n1) + "/" + str(n2)
    response = requests.get(api_url)
    result = response.json()['result']
    return result
...
def gcd(n1, n2):
    api_url = "http://172.17.0.1:5055/" + str(n1) + "/" + str(n2)
    response = requests.get(api_url)
    result = response.json()['result']
    return result
...
def lcm(n1, n2):
    api_url = "http://172.17.0.1:5056/" + str(n1) + "/" + str(n2)
    response = requests.get(api_url)
    result = response.json()['result']
    return result
...
def exponent(n1, n2):
    api_url = "http://172.17.0.1:5057/" + str(n1) + "/" + str(n2)
    response = requests.get(api_url)
    result = response.json()['result']
    return result
